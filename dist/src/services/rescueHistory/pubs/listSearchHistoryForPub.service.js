...
exports.listSearchRescueHistoryForPubService = void 0;
const data_source_1 = require("../../../data-source");
const errors_1 = require("../../../errors");
const entities_1 = require("../../../entities");
const rescueHistory_schemas_1 = require("../../../schemas/rescueHistory.schemas");
const listSearchRescueHistoryForPubService = (clientId, pubId, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const rescueHistory = rescueHistory_schemas_1.rescueHistorySchemaResponse.parse(findRescueHistory);
    return rescueHistory;
});
exports.listSearchRescueHistoryForPubService = listSearchRescueHistoryForPubService;
