...
exports.listClientUniqueService = void 0;
const data_source_1 = require("../../data-source");
const errors_1 = require("../../errors");
const entities_1 = require("../../entities");
const clients_schemas_1 = require("../../schemas/clients.schemas");
const listClientUniqueService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const client = clients_schemas_1.clientsSchemaResponse.parse(findClient);
    return client;
});
exports.listClientUniqueService = listClientUniqueService;
